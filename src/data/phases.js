...
export const PHASES = [
  ...
  },
  {
    ...
    action: t(
      "Sell in order: <b>ARKQ → EWY</b> (noise) → <b>SMH → ROBO → URA</b> (trim only). The SMH/EWY trim eased — the broad market rebounded as Iran-oil cooled (S&amp;P ~7,747), though SOX still lags (~−13% / 30d). <b>Hold BTC</b> (sell only on a <b>weekly close</b> &lt; ~$62k); keep ISAC; <b>stagger into gold</b> (~$4,071, still bid). <b>SPCX: the earnings beat collapses the binary risk — Aug 6 is the first accumulation scale.</b> The thesis held (revenue +92%, AI +250%, $100B ARR pace) while the stock fell on pure supply. See the SPCX row + SUPPLY.",
      "Vende en orden: <b>ARKQ → EWY</b> (ruido) → <b>SMH → ROBO → URA</b> (solo trim). El trim de SMH/EWY aflojó — el mercado amplio rebotó al enfriarse el petróleo-Irán (S&amp;P ~7.747), aunque el SOX aún rezaga (~−13% / 30d). <b>Mantén BTC</b> (vende solo con <b>cierre semanal</b> &lt; ~$62k); conserva ISAC; <b>escalona hacia el oro</b> (~$4.071, aún con demanda). <b>SPCX: el beat de resultados colapsa el riesgo binario — el 6 ago es el primer tramo de acumulación.</b> La tesis aguantó (revenue +92%, IA +250%, ritmo de $100B ARR) mientras la acción caía por pura oferta. Mira la fila SPCX + OFERTA."
    ),
    watch: t(
      "The binary catalysts resolved <b>well</b> (Flight 13 success Jul 24; Q2 beat Aug 4) — yet SPCX made a fresh low. <b>You're hedging timing risk (a supply-driven reversal), not the thesis.</b> Aug 6 frees 911.5M shares (~140% of the IPO float). Don't rationalize a deeper break; <b>do scale into SPCX on unlock weakness</b> — the beat proved this is a correction, not a break. Watch the unlock's <b>volume</b>, not just day-1 price.",
      "Los catalizadores binarios resolvieron <b>bien</b> (éxito del vuelo 13 el 24 jul; beat del 2T el 4 ago) — y aun así SPCX marcó un nuevo mínimo. <b>Estás cubriendo riesgo de timing (una reversión por oferta), no la tesis.</b> El 6 ago libera 911,5M acciones (~140% del float de la OPV). No racionalices una ruptura más profunda; <b>sí escala en SPCX con la debilidad del unlock</b> — el beat demostró que es corrección, no ruptura. Vigila el <b>volumen</b> del unlock, no solo el precio del día 1."
    ),
  },
];

export const TRIGGERS = [
  t("<b>CONFIRMED — and now ISOLATED to supply:</b> fresh 52-wk low <b>$104.83 Aug 5</b> (~$115.81) <i>despite</i> Flight 13 success (Jul 24) and a Q2 earnings beat (Aug 4: revenue $7.8B +92%, AI +250%). <b>~49% off the $225.64 peak</b>, cap ~$1.5T. Shorts 219.3M / ~$24.6B (34% of float, S3 Jul 29). The beat proves a <b>correction, not a thesis break</b> — Aug 6 unlock = first SPCX buy scale.",
    "<b>CONFIRMADA — y ahora AISLADA a la oferta:</b> nuevo mínimo a 52 sem <b>$104,83 el 5 ago</b> (~$115,81) <i>a pesar de</i> el éxito del vuelo 13 (24 jul) y un beat de resultados del 2T (4 ago: revenue $7,8B +92%, IA +250%). <b>~49% por debajo del pico de $225,64</b>, cap ~$1,5B. Cortos 219,3M / ~$24,6B (34% del float, S3 29 jul). El beat demuestra una <b>corrección, no ruptura de tesis</b> — el unlock del 6 ago = primer tramo de compra SPCX."),
  ...
  t("Triggers lag — the hedge covers the gap, so <b>instrument + size &gt; exact level</b>. <b>The binary risk is gone</b> (Flight 13 + earnings both passed well). Ahead: <b>Aug 6 — 911.5M-share base-20% unlock</b> (~140% of the IPO float), then the tranche ladder into December (float ~40% by Dec 8). <b>Same ladder = SPCX accumulation calendar</b>.",
    "Los disparadores rezagan — la cobertura cubre el gap, así que <b>instrumento + tamaño &gt; nivel exacto</b>. <b>El riesgo binario se fue</b> (vuelo 13 + resultados pasaron bien). Adelante: <b>6 ago — unlock base 20% de 911,5M acciones</b> (~140% del float de la OPV), luego la escalera de tramos hasta diciembre (float ~40% para el 8 dic). <b>Misma escalera = calendario de acumulación SPCX</b>."),
];
