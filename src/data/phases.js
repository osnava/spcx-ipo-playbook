...
export const PHASES = [
  ...
  },
  {
    ...
    watch: t(
      "<b>Closed Jul 7.</b> The pop never came — the Jul 6 auction absorbed the bid at $160.42, day 1 faded −5.2%, and the slide never stopped (broke the IPO <i>close</i> Jul 16, kept setting lows to a 52-week low Jul 24). Flight 13 then <b>scrubbed at T-0</b> (3rd attempt today, Jul 24). History; the playbook runs on Phase 03.",
      "<b>Cerrada el 7 jul.</b> El salto nunca llegó — la subasta del 6 jul absorbió la puja en $160,42, el día 1 se desvaneció −5,2%, y el deslizamiento nunca se detuvo (rompió la OPV al <i>cierre</i> el 16 jul, marcando mínimos hasta un mínimo a 52 semanas el 24 jul). El vuelo 13 luego <b>se abortó en T-0</b> (3er intento hoy, 24 jul). Historia; el playbook corre en la Fase 03."
    ),
  },
  {
    ...
    concept: t(
      "Forced demand spent; real price discovery rules. The slide never stopped: −5.2% day 1, through the Jun 23 $147.11 floor, the $135 IPO intraday Jul 15 ($132.28), the <i>close</i> Jul 16 ($131.11), to a fresh 52-week low Jul 24 (~$112.69; intraday $110.85) — <b>down ~50% from the $225.64 peak</b>, cap ~$1.57T. The sentiment floor (Flight 13) <b>scrubbed at T-0 Jul 16</b>; 3rd attempt is today, Jul 24.",
      "Demanda forzada agotada; manda el precio real. El deslizamiento nunca se detuvo: −5,2% el día 1, a través del suelo de $147,11 del 23 jun, la OPV de $135 intradía el 15 jul ($132,28), el <i>cierre</i> el 16 jul ($131,11), hasta un nuevo mínimo a 52 semanas el 24 jul (~$112,69; intradía $110,85) — <b>~50% a la baja desde el pico de $225,64</b>, cap ~$1,57B. El suelo de sentimiento (vuelo 13) <b>se abortó en T-0 el 16 jul</b>; el 3er intento es hoy, 24 jul."
    ),
    drivers: [
      {
      ...
      {
        label: t("CONFIRMED · new lows daily (Jul 7→24); Flight 13 retries today", "CONFIRMADA · mínimos diarios (7→24 jul); Vuelo 13 reintenta hoy"),
        text: t(
          "From <b>~$152 (Jul 7)</b>: through the $135 IPO intraday Jul 15, the <i>close</i> Jul 16 ($131.11), to a fresh 52-wk low Jul 24 (~$112.69; intraday $110.85) — cap ~$1.57T, <b>down ~26% since the Jul 7 inclusion, ~50% off the $225.64 peak</b>, ~$1.1T+ erased. Short sellers +$15.5B since IPO (Ortex, Jul 23). Flight 13 — the supposed sentiment floor — <b>scrubbed at T-0 Jul 16</b> (3rd attempt today, Jul 24). <b>Critical: the 'SPCX-only' isolation broke Jul 17</b> — <b>SOX entered a bear market</b> (−13% / 30d) on Kimi K3 (China's open AI model) + hyperscaler-capex doubts + Iran oil (Brent hit $100 on Houthi tanker attacks); the fade is <b>no longer uncorrelated</b> to SMH/EWY.",
          "Desde <b>~$152 (7 jul)</b>: a través de la OPV de $135 intradía el 15 jul, el <i>cierre</i> el 16 jul ($131,11), hasta un nuevo mínimo a 52 semanas el 24 jul (~$112,69; intradía $110,85) — cap ~$1,57B, <b>~26% a la baja desde la inclusión del 7 jul, ~50% por debajo del pico de $225,64</b>, ~$1,1B+ borrados. Cortos +$15,5B desde la OPV (Ortex, 23 jul). El vuelo 13 — el supuesto suelo de sentimiento — <b>se abortó en T-0 el 16 jul</b> (3er intento hoy, 24 jul). <b>Crítico: el aislamiento 'solo SPCX' se rompió el 17 jul</b> — el <b>SOX entró en mercado bajista</b> (−13% / 30d) por Kimi K3 (modelo abierto de China) + dudas de capex de hiperscalers + petróleo de Irán (Brent tocó $100 por ataques de hutíes a tanques); el fade <b>ya no es incorrelado</b> a SMH/EWY."
        ),
      },
      {
        label: t("Coverage wave FULL · 27 of 33 Buys, one dissenter", "Ola de cobertura COMPLETA · 27 de 33 Compras, un disidente"),
        text: t(
          "The 25-day underwriter <b>quiet period</b> (the SEC window after an IPO when underwriters can't publish research) expired; <b>27 of 33 analysts rate Buy/Strong Buy (5 hold, 1 sell), median PT ~$226</b>: Morgan Stanley $300, <b>Deutsche $255</b>, <b>Macquarie $250</b>, Oppenheimer/Needham $250, <b>Bernstein $239</b>, <b>BofA $235</b>, JPMorgan/RBC $225, Goldman $205, UBS $210, Mizuho $200, Evercore Outperform, <b>Raymond James $800</b> (Street high, implies ~$10.5T cap). <b>Morningstar dissenter: FV ≈ $780B</b> vs ~$1.6T. ARK bought the dip. <b>Narrative support ≠ forced-buy support</b> — the price/target gap is one of the widest on record.",
          "El <b>quiet period</b> de 25 días de los colocadores (la ventana de la SEC tras una IPO en la que los colocadores no pueden publicar investigación) expiró; <b>27 de 33 analistas califican Compra/Compra Fuerte (5 hold, 1 venta), objetivo mediano ~$226</b>: Morgan Stanley $300, <b>Deutsche $255</b>, <b>Macquarie $250</b>, Oppenheimer/Needham $250, <b>Bernstein $239</b>, <b>BofA $235</b>, JPMorgan/RBC $225, Goldman $205, UBS $210, Mizuho $200, Evercore Outperform, <b>Raymond James $800</b> (máximo del Street, implica cap ~$10,5B). <b>Morningstar disidente: VJ ≈ $780B</b> vs ~$1,6B. ARK compró la caída. <b>Apoyo narrativo ≠ apoyo de compra forzada</b> — el gap precio/objetivo es uno de los más amplios registrados."
        ),
      },
      {
      ...
      {
        label: t("The supply wall · Aug 4 earnings → Aug 6 unlock", "La pared de oferta · resultados 4 ago → unlock 6 ago"),
        text: t(
          "The forced buy (~$4.3B, one print) is dwarfed by what follows: <b>base 20% of insider shares unlock the 2nd trading day after Q2 earnings</b> — earnings confirmed <b>Aug 4</b>, so unlock <b>~Aug 6</b>. Would have risen to 30% if SPCX had closed <b>≥$175.50</b> on 5 of 10 days into earnings — <b>dead</b> at ~$113, so the 10% rolls into the time tranches. <b>Lockups through Dec 8 raise the float to ~40%</b>; the rest (incl. Musk) sits to mid-2027. Every major post-IPO lockup in the last decade produced at least temporary weakness. (SpaceX releases results only via its website &amp; X, not the wires.) <b>The flip side is the SPCX accumulation calendar</b> — same ladder, buy side.",
          "La compra forzada (~$4,3B, un print) queda empequeñecida por lo que sigue: <b>el 20% base de acciones de insiders se libera el 2º día tras los resultados del 2T</b> — resultados confirmados <b>4 ago</b>, así que unlock <b>~6 ago</b>. Habría subido a 30% si SPCX hubiera cerrado <b>≥$175,50</b> en 5 de 10 días hacia los resultados — <b>muerto</b> a ~$113, así que el 10% pasa a los tramos de tiempo. <b>Los lockups hasta el 8 dic elevan el float a ~40%</b>; el resto (incl. Musk) queda hasta mediados de 2027. Cada gran lockup post-IPO de la última década produjo al menos debilidad temporal. (SpaceX publica resultados solo vía su web y X, no las agencias.) <b>El reverso es el calendario de acumulación de SPCX</b> — misma escalera, lado compra."
        ),
      },
    ],
    action: t(
      "Sell in order: <b>ARKQ → EWY</b> (noise) → <b>SMH → ROBO → URA</b> (trim only). The SMH/EWY trim is now a <b>genuine AI-capex correction</b> (SOX bear market), not just SPCX correlation — raise urgency. <b>Hold BTC</b> (sell only on a <b>weekly close</b> &lt; ~$62k); keep ISAC; <b>stagger into gold</b> (Brent hit $100 on Houthi tanker attacks — a fresh bid). <b>SPCX: accumulate into the lockup waves</b> — Flight 13's 3rd attempt is today, Jul 24 (binary), so size the first scale small. See the SPCX row + SUPPLY.",
      "Vende en orden: <b>ARKQ → EWY</b> (ruido) → <b>SMH → ROBO → URA</b> (solo trim). El trim de SMH/EWY es ahora una <b>corrección real de capex de IA</b> (SOX en mercado bajista), no solo correlación con SPCX — súbele la urgencia. <b>Mantén BTC</b> (vende solo con <b>cierre semanal</b> &lt; ~$62k); conserva ISAC; <b>escalona hacia el oro</b> (Brent tocó $100 por ataques de hutíes a tanques — un nuevo impulso). <b>SPCX: acumula en las olas del lockup</b> — el 3er intento del vuelo 13 es hoy, 24 jul (binario), dimensiona el primer tramo pequeño. Mira la fila SPCX + OFERTA."
    ),
    watch: t(
      "You're hedging <b>timing risk</b> (a temporary reversal), not the thesis. The reversal stopped being SPCX-only Jul 17 (SOX bear market). <b>Earnings Aug 4 → base 20% unlock ~Aug 6.</b> Don't rationalize a deeper break; don't front-run SPCX accumulation — Flight 13's 3rd attempt is today, Jul 24 (binary), then stagger into the Aug 6 wave.",
      "Estás cubriendo <b>riesgo de timing</b> (una reversión temporal), no la tesis. La reversión dejó de ser solo SPCX el 17 jul (SOX en mercado bajista). <b>Resultados 4 ago → desbloqueo base 20% ~6 ago.</b> No racionalices una ruptura más profunda; no te adelantes a la acumulación de SPCX — el 3er intento del vuelo 13 es hoy, 24 jul (binario), luego escalona en la ola del 6 ago."
    ),
  },
];

export const TRIGGERS = [
  t("<b>CONFIRMED & DEEPENING (Jul 7→24):</b> new lows daily. IPO line intraday Jul 15 ($132.28), on the <i>close</i> Jul 16 ($131.11), 52-week low Jul 24 (~$112.69; intraday $110.85) — cap ~$1.57T, <b>~50% off the $225.64 peak</b>, ~$1.1T+ erased. Short sellers +$15.5B (Ortex, Jul 23). Flight 13 <b>scrubbed at T-0</b> (3rd attempt today, Jul 24). Sell now: ARKQ → EWY first.",
    "<b>CONFIRMADA Y PROFUNDIZÁNDOSE (7→24 jul):</b> mínimos diarios. Línea de OPV intradía el 15 jul ($132,28), al <i>cierre</i> el 16 jul ($131,11), mínimo a 52 semanas el 24 jul (~$112,69; intradía $110,85) — cap ~$1,57B, <b>~50% por debajo del pico de $225,64</b>, ~$1,1B+ borrados. Cortos +$15,5B (Ortex, 23 jul). El vuelo 13 <b>se abortó en T-0</b> (3er intento hoy, 24 jul). Vende ya: ARKQ → EWY primero."),
  ...
  t("<b>DIVERGENCE NARROWING (watch):</b> BTC faded to <b>~$63.9k Jul 24</b>, back near its 200-week average (~$62k) — no longer rallying while SPCX falls. Gauge still <b>OFF</b> (no weekly break below ~$62k), but the 'SPCX-only' isolation is gone (SOX bear). Re-arm the broad-risk sell only on a <b>weekly close</b> &lt; ~$62k on rising volume.",
    "<b>DIVERGENCIA ESTRECHÁNDOSE (vigilar):</b> BTC retrocedió a <b>~$63,9k el 24 jul</b>, de vuelta cerca de su media de 200 semanas (~$62k) — ya no sube mientras SPCX cae. Medidor aún <b>APAGADO</b> (sin ruptura semanal bajo ~$62k), pero el aislamiento 'solo SPCX' se fue (SOX bajista). Re-arma la venta de riesgo amplio solo con <b>cierre semanal</b> &lt; ~$62k con volumen creciente."),
  t("Triggers lag — the hedge covers the gap, so <b>instrument + size &gt; exact level</b>. Ahead: <b>Flight 13 3rd attempt (today, Jul 24)</b> (binary), then <b>Q2 results Aug 4 → 20% base unlock ~Aug 6</b>, then the tranche ladder into December (float ~40% by Dec 8). <b>Same ladder = SPCX accumulation calendar</b>.",
    "Los disparadores rezagan — la cobertura cubre el gap, así que <b>instrumento + tamaño &gt; nivel exacto</b>. Adelante: <b>3er intento vuelo 13 (hoy, 24 jul)</b> (binario), luego <b>resultados 2T 4 ago → desbloqueo base 20% ~6 ago</b>, luego la escalera de tramos hasta diciembre (float ~40% para el 8 dic). <b>Misma escalera = calendario de acumulación SPCX</b>."),
];
